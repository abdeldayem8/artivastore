     ...
     <div className="max-w-7xl mx-auto my-4 px-4 py-8">
            ...
            <Slider {...settings}>
                {data && data.map((product) => (
                    <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden mx-4  p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-5">
                {data && data.length > 0 ? (
                    data.map((product) => (
                        <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden my-8">
                            <img
                                src={product.image}
                                alt={product.title}
