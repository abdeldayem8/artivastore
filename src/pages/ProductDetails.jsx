        ...
        <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row mb-8">
          ...
          <div className="flex-1 flex flex-col-reverse gap-3 sm:flex-row">
            ...
            <div className="w-full sm:w-[80%]">
              <img
                className="w-full h-auto hover:scale-90 transition ease-in-out cursor-pointer"
                src={image}
              />
            </div>
          </div>
          ...
          <div className="flex-1 ">
            ...
            <div className="flex items-center gap-2 my-4">
              <button
                className="bg-transparent border border-white-500   px-8 py-3 text-sm"
                onClick={() =>
                  dispatch(
                    addToCart({
                      ...productdetails,
              ...
              <button
                ...
                className="bg-primary text-secondary dark:bg-secondary dark:text-primary px-8 py-3 text-sm active:bg-gray-700"
              >
                BUY IT NOW
              </button>
            </div>
